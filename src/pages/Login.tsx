      ...
      <div className="hidden lg:flex w-1/2 bg-hero items-center justify-center p-12">
        <div className="max-w-md text-center">
          ...
          <p className="text-primary-foreground/60">
            Sign in to access the complaint management system and track your requests.
          </p>
        </div>
      </div>
        ...
        >
          ...
          <form
            onSubmit={(e) => {
              ...
              else if (email.includes("staff")) window.location.href = "/staff";
          ...
          <div className="mt-4 p-3 rounded-lg bg-muted text-xs text-muted-foreground">
            <p className="font-semibold mb-1">Demo Shortcuts:</p>
            <p>Use "admin@" for Admin, "staff@" for Staff, anything else for Student.</p>
          </div>
        </motion.div>
      </div>
    </div>
